...
def simulate_progress(task_name, total_size, current, speed, eta): """ Simulated progress bar message. """ return ( f"\n╭━━━━❰ᴘʀᴏɢʀᴇss ʙᴀʀ❱━➣\n" f"┣⪼ 🗃️ Sɪᴢᴇ: {current:.2f} Mʙ | {total_size:.2f} Mʙ\n" f"┣⪼ ⏳️ Dᴏɴᴇ : {((current/total_size)*100):.2f}%\n" f"┣⪼ 🚀 Sᴩᴇᴇᴅ: {speed:.2f} Mʙ/s\n" f"┣⪼ ⏰️ Eᴛᴀ: {eta}ꜱ\n" "╰━━━━━━━━━━━━━━━➣" )

def format_filename(filename): """ File name ko clean aur valid format me convert karta hai. """ return filename.replace(" ", "").replace("/", "")
